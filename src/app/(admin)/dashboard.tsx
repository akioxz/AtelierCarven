...
export default function Dashboard() {
  ...
  const narrow = Platform.OS === "web" && width < layout.narrowBreakpoint;
  ...
  const isEmpty = stats.furniture === 0 && stats.users === 0 && recentLogs.length === 0;
