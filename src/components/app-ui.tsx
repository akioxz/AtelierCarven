...
const styles = StyleSheet.create({
  brandOverline: { color: Design.color.gold, fontFamily: Design.font.bodySemibold, fontSize: 11, letterSpacing: 3.2 },
  ...
  overline: { color: Design.color.gold, fontFamily: Design.font.bodySemibold, fontSize: 11, letterSpacing: 2.5, textTransform: "uppercase" },
  ...
  secondaryButton: { alignItems: "center", backgroundColor: "transparent", borderColor: Design.color.gold, borderRadius: Design.radius.small, borderWidth: 1, justifyContent: "center", minHeight: 52, paddingHorizontal: 20 },
  secondaryButtonLabel: { color: Design.color.ink, fontFamily: Design.font.bodyBold, fontSize: 11, letterSpacing: 1.25 },
  textLink: { alignSelf: "flex-start" },
  textLinkLabel: { color: Design.color.gold, fontFamily: Design.font.bodySemibold, fontSize: 13, textDecorationLine: "underline" },
  ...
  mobileNavLabel: { color: Design.color.inkMuted, fontFamily: Design.font.bodyMedium, fontSize: 11 },
