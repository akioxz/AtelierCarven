...
export function ProductCard({
  ...
  return (
    <Reveal delay={staggerDelay(index)} style={styles.reveal}>
      <PressScale onPress={onPress} accessibilityLabel={`View ${item.name}`} style={styles.card}>
...
const styles = StyleSheet.create({
  ...
  heart: { alignItems: "center", backgroundColor: Design.color.surface, borderRadius: 19, height: 38, justifyContent: "center", position: "absolute", right: 10, top: 10, width: 38 },
  heartActive: { borderColor: Design.color.goldSoft, borderWidth: 1 },
  copy: { gap: 4, padding: 14 },
  ...
  metaRow: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginTop: 2 },
