      ...
      <View style={styles.backdrop}>
        <View style={styles.card} accessibilityViewIsModal>
          <View style={[styles.iconWrap, danger && styles.iconWrapDanger]}>
            <Feather name={icon} size={20} color={danger ? Design.color.danger : Design.color.gold} />
          </View>
...
const styles = StyleSheet.create({
  backdrop: { flex: 1, backgroundColor: "rgba(33,26,22,0.45)", alignItems: "center", justifyContent: "center", padding: 24 },
  ...
  iconWrap: { alignItems: "center", backgroundColor: Design.color.goldSoft, borderRadius: 26, height: 52, justifyContent: "center", width: 52 },
  iconWrapDanger: { backgroundColor: "#FCEBEB" },
